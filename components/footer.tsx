        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>help@sehatsaathi.com</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#for-doctors" className="text-muted-foreground hover:text-primary transition-colors">
                  For Doctors
                </a>
              </li>
              <li>
                <a href="#for-asha" className="text-muted-foreground hover:text-primary transition-colors">
                  For ASHA Workers
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-muted-foreground">Tele-Consultation</span>
              </li>
              <li>
                <span className="text-muted-foreground">Medicine Delivery</span>
              </li>
              <li>
                <span className="text-muted-foreground">Digital Health Records</span>
              </li>
              <li>
                <span className="text-muted-foreground">AI Symptom Guide</span>
              </li>
              <li>
